...
const NewsMma = (props) => {
  ...
  useEffect(() => {
    async function getData(currentPage) {
      setLoading(true);
      let apiUrl = "dropmmanews?p=" + currentPage;
