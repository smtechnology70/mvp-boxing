      ...
      >
        <div className="left_content_area">
          <h1 className="titles_article border_titles_article1">
            <span itemProp="name">
              Kids and Juniors Boxing Training | Personal Boxing Trainer | Manny
              Masson | MVP Boxing
            </span>{" "}
          ...
          <div className="workout_content update-workout_content">
            <div style={{ margin: "25px 0 25px 0" }}>
              <img
                src="/assets/userfiles/images/kid1.jpg"
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    <p>
                      Discipline, self-confidence, respect, integrity,
                      commitment, responsibility, leadership qualities and
                      personal drive and motivation are some of the core
                      principles for success in sports and in all aspects of
                      life. The aforementioned core values, however, are rarely
                      taught to children in a structured school environment. The
                      practice of combat sports is seen as a means to individual
                      physical and mental development, and our ‘Kids and Juniors
                      Program’ emphasize development of these important life
                      skills.
                    </p>
                  </div>
                </div>
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-header" id="heading1">
                    <h5 className="mb-0 question">
                      <strong>
                        The kids and juniors Boxing and BJJ programs are
                        designed to:
                      </strong>
                      <span className="right">
                        <i
                    ...
                    <ul className="pl-1">
                      <li>
                        <i
                          ...
                          aria-hidden="true"
                        />
                        &nbsp;Teach a comprehensive self-defense system that
                        will give children a high degree of self-confidence.
                      </li>
                      <li>
                        <i
                          className="fa fa-check-square-o"
                          aria-hidden="true"
                        />
                        &nbsp;Teach children how to protect themselves against
                        bullies and intelligently cope with peer pressure.
                      </li>
                      <li>
                        <i
                          className="fa fa-check-square-o"
                          aria-hidden="true"
                        />
                        &nbsp;Teach core values such as respect, humility,
                        dignity and honesty.
                      </li>
                    </ul>
                    <p>
                      {`We offer instructional classes for kids and teach them in
                      a fun manner. The kid's program integrates self-defense
                      techniques with physical conditioning drills and skill
                      oriented games aimed at improving your child's
                      coordination, rhythm, focus, motor skills, agility,
