        ...
        <div className="left_content_area" style={{ margin: 0 }}>
          ...
          >
            <div style={{ margin: "25px 0 25px 0" }}>
              <img
                src="/assets/menusImg/e3a3d53b49939c276fa7f21f1e3fdb3a.JPG"
            ...
            <div id="accordion" className="accordion">
              <div className="card mb-1">
                ...
                >
                  <div className="card-header" id="heading0">
                    <h5 className="mb-0 question">
                      <strong>Description of Thai-Boxing</strong>
                ...
                >
                  <div className="card-body">
                    <p>
                      Thai-boxing, the national sport of Thailand, is perhaps
                      the most brutal sport in existence. Participants batter
                      each other with punches, kicks, knees and elbows. There
                      are few rules in Thai-boxing and boils down to survival of
                      the fittest. A match consists of five, three minute
                      rounds. Punching, knee and elbow strikes and kicking
                      techniques are allowed to any part of the body, except the
                      groin. Because of the hard, fast paced action, it is very
                      important for the fighters to be highly conditioned, both
                      physically and mentally. A fighter entering the ring in
                      anything but top condition can expect, at the very least,
                      to be knocked unconscious. There is also a chance of death
                      if not properly prepared. In Thailand, there are many
                      deaths each year as a result of the beating taken in the
                      ring.
                    </p>
                    <p>
                      {`Much of the Thai-boxers conditioning is done on the
                      Thai-pads. Thai-pads are solid, heavy pads strapped to the
                      arms of a holder. This method of training is advantageous
                      to the heavy bag in that it allows the fighter to respond
                      to a "live" opponent. The holders job varies, depending on
                      the desired results of the training session. For some
                      drills, the holder attacks with kicks to the legs, body or
                      head, and punches to the body and head. While defending
                      himself, the fighter throws his own kicks, knees and
                      elbows. Using another method, the holder remains
                      relatively stationary and allows the fighter to attack
                      with a pre-designated combination or a free flow barrage
                      of kicks, knees, and elbows.`}
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  <div className="card-body">
                    <p>
                      ...
                      Thaiboxing and any sport. The systems identified are the
                      ATP, ATP-CP, Lactic Acid and the Aerobic-oxidative system.
                      A basic understanding of these systems is helpful in
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    <p>
                      ATP (adenosine triphosphate) is the immediate source of
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-header" id="heading7">
                    <h5 className="mb-0 question">
                      <strong>Recovery of the Anaerobic Systems</strong>
                      <span className="right">
                        <i
                          className="arrow fa fa-arrow-right"
                          aria-hidden="true"
                ...
                >
                  <div className="card-body">
                    <p>
                      ...
                      seconds, 87% is restored. Almost all of the ATP and CPare
                ...
                >
                  <div className="card-body">
                    <p>
                      ...
                      intensity whoset a goal of increased performance. Both
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-header" id="heading15">
                    <h5 className="mb-0 question">
                      <strong>Thai-Pad Training</strong>
                      <span className="right">
                        <i
                          className="arrow fa fa-arrow-right"
                          aria-hidden="true"
                ...
                >
                  <div className="card-body">
                    <p>
                      ...
                      Thai-pad workouts. The chart is used in the following
                      manner: l. Determine what system needs to be trained and
                      locate it in the Systems column. 2. Read across the row
                      and make a note of how long each round is and the amount
                      of rest between rounds. 3. Take the value in the % Max HR
                      column and plug it into the THR formula. If the column
                      gives two values, calculate the THR for each. The results
                      are termed the training-sensitive zone. This zone will
                      give optimal physiological results for the system picked.
                      Following the same principles (system, work rest ratio, %
                      max HR, etc.) many other training methods can be devised.
                      Other methods of training can be used with the chart as
                      well. Some other methods of training that are also
                      important to Thai-boxing include running (especially
                      sprints), heavybag, speedbag, sparring, jump- rope,
                      shadow-boxing, plyometrics, medicine ball training, and
                      focus mitts.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="card-body">
                    <p>
                      ...
                      Thai-boxing. Strength is the amount of force that can be
                      ...
                      obvious when applied to Thai- boxing. Many trainers of
                      Thai and Western boxing feel that weight training will
                      make the athlete muscle bound and slow them down. All
                      research conclusively demonstrates that a properly
                      designed and implemented program will increase speed and
                      power. Take a look at the World Record holder in the 100
                      meters. Leroy Burrell is obviously a fan of weight
                      training. Is Evander Holyfield slow?
                    </p>
                    <p>
                ...
                >
                  <div className="card-body">
                    <p>
                      ...
                      made following a periodization schedule schedule. The
                      periodization cycle can be found in Appendix D for weight
                      training and in Appendix E for Thai-pads.
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  <div className="card-body">
                    <p>
                      ...
                      objective is to stick with it. On days you feel like
                      skipping the workout, remind yourself of your goals. It's
                      better to decrease the intensity and do the workout then
                      to not do it at all. The #l reason for quitting an
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    <p>
                      4 minutes, easy kicks. 4 minutes, recovery, stretching. 2
                      minutes, easy Form, kicks, knees and elbows. 2 minutes,
                      recovery.
                    </p>
                  </div>
                </div>
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    <p>
                      8 sec. easy, 8 sec. full speed, 24 sec. rest, 4 rounds. 1
                      minute rest GUTBUSTERS 10 sec. full speed, 30 sec. rest, 4
                      rounds. 3 minutes rest.
                    </p>
                  </div>
                </div>
              </div>
