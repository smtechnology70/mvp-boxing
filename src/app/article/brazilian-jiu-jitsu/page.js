...
export default function BjjTraining() {
  ...
  useEffect(() => {
    ...
    async function getData() {
      const apiUrl = `${GLOBALS.API_BASE_URL.replace(
        /\/$/,
        ""
      )}/cmspage?page_id=contact-us`;
      try {
        ...
        console.error("Failed to fetch BJJ page data:", e);
      } finally {
        setLoading(false);
      }
    }
      ...
      >
        <div className="left_content_area" style={{ margin: 0 }}>
          <h1 className="titles_article border_titles_article1">
            <span itemProp="name">
              Brazilian Jiu-Jitsu: Martial Art, Combat Sport, Self-Defense | MVP
              Boxing
            </span>
          ...
          <div className="workout_content update-workout_content">
            <div style={{ margin: "25px 0" }}>
              <img
                src="https://www.mvpboxing.com/assets/userfiles/images/bjj.jpg"
            ...
            <div id="accordion" className="accordion">
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-header" id="heading0">
                    <h5 className="mb-0 question">
                      <strong>Description of BJJ</strong>
                ...
                >
                  <div className="card-body">
                    <p>
                      Brazilian Jiu-Jitsu is a martial art, combat sport, and a
                      form of self-defense that focuses on grappling and ground
                      fighting. It promotes the principle that a smaller,
                      physically weaker individual can successfully defend
                      themselves against a bigger, stronger assailant using
                      leverage and proper technique; most notably, by applying
                      joint-locks and chokeholds to defeat them.
                    </p>
                    <p>
                      Brazilian Jiu Jitsu (BJJ) has become one of the most in
                      demand martial art due to its usage in the MMA
                      competition. At Masson Academy you’re welcome to train
                      amongst the best instructors and students no matter your
                      level of expertise.
                    </p>
                  </div>
                </div>
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    <p>
                      The new student will engage in a learning journey based in
                      the origins of Brazilian Jiu-Jitsu and learn the most
                      effective ground self-defense system.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    <p>
                      The young student will embark on a fun and motivational
                      journey exploring the fundamentals of Brazilian Jiu-Jitsu
                      while gaining self-respect, confidence and leadership
                      skills.
                    </p>
                  </div>
                </div>
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-header" id="heading3">
                    <h5 className="mb-0 question">
                      <strong>Fundamentals Program</strong>
                      <span className="right">
                        <i
                          className="arrow fa fa-arrow-right"
                          aria-hidden="true"
                ...
                >
                  <div className="card-body">
                    <p>
                      <strong>Blue Belt</strong>
                    </p>
                    <p>
                      The Blue Belt Program is the first level for adults (over
                      the age of 16) beginning their Brazilian Jiu-Jitsu
                      training. Students will learn the fundamentals of BJJ and
                      basic techniques. Class structure is formed around a
                      warm-up, a lesson in technique and partner training to
                      practice the technique from the lesson.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-header" id="heading4">
                    <h5 className="mb-0 question">
                      <strong>Advanced Programs</strong>
                      <span className="right">
                        <i
                          className="arrow fa fa-arrow-right"
                          aria-hidden="true"
                ...
                >
                  <div className="card-body">
                    <p>
                      <strong>Purple Belt</strong>
                    </p>
                    <p>
                      Masson Advanced Curriculum is primarily focused on
                      competition BJJ with the Gi. If the student would like to
                      train self-defense they may come to the fundamentals
                      classes, until a Blue belt is attained.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    ...
                    <p>
                      This program is built upon three different curriculums:
                      BJJ, BJJ No-Gi, and BJJ for MMA. The student will
                      consolidate his/her Jiu-Jitsu expertise and complete the
                      path towards their Black belt. All new students must
                      undergo an evaluation by a black belt professor (Intro
                      class) who will make a professional recommendation to
                      which program the student should enroll.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    <p>
                      Your progress is a direct consequence of your efforts. At
                      Masson Academy, Belts or Stripes are not given, they are
                      earned. Progress will be carefully evaluated and monitored
                      by our instructors board.
                    </p>
                    <br />
                    <p>
                      For any further information regarding Masson Academy
                      programs please visit the academy in person and speak with
                      a program director.
                    </p>
                  </div>
                </div>
            ...
            {/* If your CMS returned extra HTML you want to append: */}
            {pagedata && (
              <div
                className="card-body"
