  ...
  useEffect(() => {
    ...
    async function getData() {
      const apiUrl = `${GLOBALS.API_BASE_URL.replace(
        /\/$/,
        ""
      )}/cmspage?page_id=partnership-inquiries`;
      try {
        ...
        console.error("Failed to fetch Concussions page data:", e);
      } finally {
        setLoading(false);
      }
    }
      ...
      >
        <div className="left_content_area" style={{ margin: 0 }}>
          <h1 className="titles_article border_titles_article1">
            <span itemProp="name">
              The Link Between CTE, Boxing and Football | MVP Boxing
            </span>
            <div className="socialInfo">
              <div className="left">
                mvpboxing&nbsp;|&nbsp;
                <i className="fa fa-clock-o" aria-hidden="true" />
                &nbsp;March 28, 2018, 07:47PM
              </div>
              <div className="clear" />
            </div>
          </h1>
          ...
          <div className="workout_content update-workout_content">
            <div style={{ margin: "25px 0" }}>
              <img
                src="https://www.mvpboxing.com/assets/userfiles/images/brain_cte.jpg"
                alt="CTE Illustration"
            ...
            <div id="accordion" className="accordion">
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    <p>
                      <strong>Chronic traumatic encephalopathy (CTE)</strong> is
                      a progressive degenerative disease, diagnosed post-mortem
                      in individuals with a history of multiple concussions and
                      other forms of head injury. A variant of the condition,
                      Dementia Pugilistica (DP), is primarily associated with
                      prize fighting and American football. CTE has been most
                      commonly found in professional athletes participating in
                    ...
                    <ul className="pl-1">
                      ...
                      <li>
                        <i
                          ...
                          aria-hidden="true"
                        />
                        &nbsp;Ice hockey, professional wrestling, rugby
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="card mb-1">
                ...
                >
                  <div className="card-body">
                    <p>
                      The latest research findings suggest that there’s a direct
                      correlation between the blast exposure by military service
                      personnel and/or a concussive head injury by individuals
                      who have experienced head trauma resulting in degeneration
                      of brain tissue and the subsequent development of CTE
                      (accumulation of toxic tau protein). ...
                    </p>
                  </div>
                </div>
              </div>

              {/* ... repeat for collapse2 through collapse9 ... */}
            </div>
            <p>
              Article by:&nbsp;Wikipedia;&nbsp;Reference:&nbsp;Nadia Kounang-CNN
              Medical;&nbsp;Published by:&nbsp;<strong>mvpboxing.com</strong>
            </p>
          </div>
