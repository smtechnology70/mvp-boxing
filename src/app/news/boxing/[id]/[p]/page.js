...
const NewsDetails = (props) => {
  ...
  useEffect(() => {
    async function getData() {
      setLoading(true);
      let apiUrl = "boxingfightstremsdetails?id=" + id;
      ...
      let apiUrlList = "dropboxingnews?p=" + p;
                  ...
                  >
                    <ul className="list-group" id="news-list">
                      {listdata.map((item, i) => {
                        return (
                          <Fragment key={i}>
                            <Link href={"/news/boxing/" + item.id + "/" + p}>
                              <li
                                key={i}
                            ...
                            return (
                              ...
                              >
                                ...
                                >
                                  ...
                                  <span className="fnt12 socialInfo w-100 left pad10 ng-binding">
                                    yahoo sports boxing&nbsp;|&nbsp;
                                    <i
                                      class="fa fa-clock-o"
                                      aria-hidden="true"
